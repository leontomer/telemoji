...
export const removeFriend =
  ({ userFriendId }: { userFriendId: string }) =>
  async (dispatch) => {
    try {
...
export const approvePendingFriendRequest =
  ({ userFriendEmail }: { userFriendEmail: string }) =>
  async (dispatch) => {
...
export const setFriendInFocus = (friend: FriendProps | null) => (dispatch) => {
  dispatch({
...
export const pendingFriendRequestsListener =
